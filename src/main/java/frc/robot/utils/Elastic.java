...
public final class Elastic {
        ...
        /**
         * Selects the tab of the dashboard with the given name. If no tab matches the name, this
         * will have no effect on the widgets or tabs in view.
         *
         * <p>If the given name is a number, Elastic will select the tab whose index equals the
         * number provided.
         *
        ...
        /**
         * Selects the tab of the dashboard at the given index. If this index is greater than or
         * equal to the number of tabs, this will have no effect.
         *
        ...
        public static class Notification {
                @JsonProperty("level") private NotificationLevel level;

                @JsonProperty("title") private String title;

                @JsonProperty("description") private String description;

                @JsonProperty("displayTime") private int displayTimeMillis;
                 ...
                 * @param displayTimeMillis the time in milliseconds for which the notification is
                 *     displayed
                ...
                /**
                 * Creates a new Notification with specified dimensions and default display time. If
                ...
                /**
                 * Gets the description text of this notification.
                 *
                 ...
                 *
                 * @param displayTimeMillis the number of milliseconds to display the notification
                 *     for
                 */
                ...
                /**
                 * Modifies the notification's description and returns itself to allow for method
                 * chaining
                 *
                 * @param description the description to set the notification to
                 * @return the current notification
                ...
                /**
                 * Modifies the notification's display time and returns itself to allow for method
                 * chaining
                 *
                 * @param seconds the number of seconds to display the notification for
                 * @return the current notification
                 ...
                 * chaining
                 *
                 * <p>This will set the height to -1 to have it automatically determined by the
                 * dashboard
                 *
                 * @return the current notification
                 */
                 ...
                 *
                 * <p>The auto dismiss behavior can be re-enabled by setting the display time to a
                ...
                /**
                 * Represents the possible levels of notifications for the Elastic dashboard. These
                 * levels are used to indicate the severity or type of notification.
                 */
