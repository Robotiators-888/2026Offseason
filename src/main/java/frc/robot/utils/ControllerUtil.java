...
public class ControllerUtil {
         ...
         */
        public ControllerUtil(CommandSwerveDrivetrain drivetrain, SUB_Linear linear,
            SUB_Roller roller, SUB_Index index, SUB_PhotonVision photonVision, SUB_Shooter shooter,
            SUB_Hood hood, SUB_Metering metering, CommandXboxController Driver1,
        ...
        private void configureDriver2Bindings() {
                ...
                Driver2.x().onTrue(new InstantCommand(() -> {
                        targetRPM =
                            shooter.getZonedRPM(drivetrain.getPose().getTranslation().getDistance(
                                SUB_PhotonVision.getInstance()
                                    .at_field
                                    .getTagPose(DriverStation.getAlliance().orElse(Alliance.Blue)
                                                == Alliance.Red
