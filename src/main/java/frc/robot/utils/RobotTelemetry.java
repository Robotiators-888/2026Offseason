...
public class RobotTelemetry {
        ...
        private void logDrivetrain() {
                ...
                for (int i = 0; i < drivetrain.getModules().length; i++) {
                        ...
                        SmartDashboard.putNumber("Drivetrain/Motors/Current/Drive Motor ID "
                                + driveMotorId + " Stator Current",
                            driveMotor.getStatorCurrent().getValueAsDouble());
                        SmartDashboard.putNumber("Drivetrain/Motors/Current/Steer Motor ID "
                                + steerMotorId + " Stator Current",
                            steerMotor.getStatorCurrent().getValueAsDouble());
                        SmartDashboard.putNumber("Drivetrain/Motors/Current/Drive Motor ID "
                                + driveMotorId + " Supply Current",
                            driveMotor.getSupplyCurrent().getValueAsDouble());
                        SmartDashboard.putNumber("Drivetrain/Motors/Current/Steer Motor ID "
                                + steerMotorId + " Supply Current",
                            steerMotor.getSupplyCurrent().getValueAsDouble());
                        SmartDashboard.putNumber("Drivetrain/Motors/Voltage/Drive Motor ID "
                                + driveMotorId + " Motor Voltage",
                            driveMotor.getMotorVoltage().getValueAsDouble());
                        SmartDashboard.putNumber("Drivetrain/Motors/Voltage/Steer Motor ID "
                                + steerMotorId + " Motor Voltage",
                            steerMotor.getMotorVoltage().getValueAsDouble());
                        SmartDashboard.putNumber("Drivetrain/Motors/Voltage/Drive Motor ID "
                                + driveMotorId + " Supply Voltage",
                            driveMotor.getSupplyVoltage().getValueAsDouble());
                        SmartDashboard.putNumber("Drivetrain/Motors/Voltage/Steer Motor ID "
                                + steerMotorId + " Supply Voltage",
                            steerMotor.getSupplyVoltage().getValueAsDouble());
                        SmartDashboard.putNumber(
                            "Drivetrain/Motors/RPM/Drive Motor ID " + driveMotorId + " RPM",
                            driveMotor.getVelocity().getValue().baseUnitMagnitude());
                        SmartDashboard.putNumber(
                            "Drivetrain/Motors/RPM/Steer Motor ID " + steerMotorId + " RPM",
                            steerMotor.getVelocity().getValue().baseUnitMagnitude());
                        SmartDashboard.putNumber(
                            "Drivetrain/Motors/Pos/Drive Motor ID " + driveMotorId + " Encoder Pos",
                            driveMotor.getPosition().getValueAsDouble());
                        SmartDashboard.putNumber(
                            "Drivetrain/Motors/Pos/Steer Motor ID " + steerMotorId + " Encoder Pos",
                            steerMotor.getPosition().getValueAsDouble());
                        SmartDashboard.putNumber("Drivetrain/Motors/Current/Drive Motor ID "
                                + driveMotorId + " Torque Current",
                            driveMotor.getTorqueCurrent().getValueAsDouble());
                        SmartDashboard.putNumber("Drivetrain/Motors/Current/Steer Motor ID "
                                + steerMotorId + " Torque Current",
                            steerMotor.getTorqueCurrent().getValueAsDouble());
                        SmartDashboard.putNumber("Drivetrain/Motors/Temp/Drive Motor ID "
                                + driveMotorId + " Device Temp",
                            driveMotor.getDeviceTemp().getValueAsDouble());
                        SmartDashboard.putNumber("Drivetrain/Motors/Temp/Steer Motor ID "
                                + steerMotorId + " Device Temp",
                            steerMotor.getDeviceTemp().getValueAsDouble());
                        SmartDashboard.putNumber("Drivetrain/Motors/Temp/Drive Motor ID "
                                + driveMotorId + " Processor Temp",
                            driveMotor.getProcessorTemp().getValueAsDouble());
                        SmartDashboard.putNumber("Drivetrain/Motors/Temp/Steer Motor ID "
                                + steerMotorId + " Processor Temp",
                            steerMotor.getProcessorTemp().getValueAsDouble());
                        SmartDashboard.putNumber("Drivetrain/Motors/AbsEncoder/Encoder ID "
                                + drivetrain.getModule(i).getEncoder().getDeviceID() + " Position",
        ...
        public void logPDH() {
                ...
                SmartDashboard.putNumberArray(
                    "PDH/All Currents Amps", powerDistribution.getAllCurrents());
                SmartDashboard.putNumber(
                    "PDH/Tempurature Celsius", powerDistribution.getTemperature());
                SmartDashboard.putNumber(
