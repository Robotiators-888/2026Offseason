...
public final class Constants {
        ...
        public static final class Linear {
                ...
                public static final double kLINEAR_FORWARD_SETPOINT =
                    360.0 * 4.2; // Degrees (Relative)
                ...
                public static final PIDController kLINEAR_FAST_PID_CONTROLLER =
                    new PIDController(4, 0, 0); // Change the values!!!
                public static final PIDController kLINEAR_SLOW_PID_CONTROLLER =
                    new PIDController(1, 0, 0); // Change the values!!!
        }
